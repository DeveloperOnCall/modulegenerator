...
class ModuleGeneratorControllerCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'modulegenerator:controller
    ...
    {
        return config('modulegenerator.custom_template')
        ? config('modulegenerator.path') . '/controller.stub'
    ...
    protected function buildClass($name)
    {
        ...
        //$viewPath = app_path('Modules\\'.str_singular($crudName).'\\Http\\Controllers');
        /* ModuleGenerator */
        ...
        $useModel = 'App\\Modules\\Models\\'.$modelName;
...
EOD;
        ...
        return $this->replaceNamespace($stub, $name)
            ...
            ->replaceModelNamespace($stub, $modelNamespace, $useModel)
            ->replaceUseModel($stub, $useModel)
     ...
     * @return $this
     */
    protected function replaceModelNamespace(&$stub, $modelNamespace, $useModel)
    {
     ...
     * @return $this
     */
    protected function replaceUseModel(&$stub, $useModel)
    {
        $stub = str_replace('{{useModel}}', $useModel, $stub);
