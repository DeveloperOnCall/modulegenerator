...
class ModuleGeneratorLangCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'modulegenerator:lang
    ...
    public function handle()
    {
        ...
        foreach ($this->locales as $locale) {
            ...
            $path = base_path('Modules/'.ucwords($this->crudName.'/Resources/Lang/')) . $locale . '/';
