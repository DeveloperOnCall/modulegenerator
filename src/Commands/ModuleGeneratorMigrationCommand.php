...
class ModuleGeneratorMigrationCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'modulegenerator:migration
    ...
    protected function getStub()
    {
        ...
        ? config('modulegenerator.path') . '/migration.stub'
    ...
    protected function getPath($name)
    {
        ...
        $m_path = module_path(ucwords($name).'/Database/Migrations/'). $datePrefix . '_create_' . $name . '_table.php';
        return $m_path; // ('/migrations/') . $datePrefix . '_create_' . $name . '_table.php';
    }
